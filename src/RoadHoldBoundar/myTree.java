...
//        jTree.setEditable(true);
    ...
    public void actionPerformed(ActionEvent e) {
            if (e.getSource() == jMenuItem1) {
                ...
                MainBoundar.jTextArea.append((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(System.currentTimeMillis()) + "  开始显示频谱图\n");
                ...
                MainBoundar.jTextArea.append((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(System.currentTimeMillis()) + "  开始参数设置\n");
            }
        }
